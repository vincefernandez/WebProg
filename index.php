                ...
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="text" id="text" readonly placeholder="Scan Now!" class="form-control">
                            <button class="h1 btn btn-primary text-center text-black form-control" onclick="startCam();">Scan Now!</button>
        ...
        <script>
            function startCam() {
                ...
                scanner.addListener('scan', function(c) {
                        if (c === 'vincent') {
                            window.location = 'https://localhost/new1/homepage.php';
                            scanner.stop();
